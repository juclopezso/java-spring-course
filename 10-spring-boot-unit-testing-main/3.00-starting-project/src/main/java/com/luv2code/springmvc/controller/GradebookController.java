...
public class GradebookController {
	...
	public String deleteStudent(@PathVariable int id, Model m) {
		// get the student
		if (!studentAndGradeService.checkIfStudentNullById(id)) {
			return "error";
		}
	...
	public String createGrade(@RequestParam("grade") double grade,
		...
		if (!studentAndGradeService.checkIfStudentNullById(studentId)) {
			return "error";
		}
	...
	public String deleteGrade(@RequestParam int id, @RequestParam String gradeType, Model m) {
